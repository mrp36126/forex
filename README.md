...
3. Backtest on 2–3 years of realistic data with spread/slippage assumptions.
4. Reject fragile results rather than optimizing until they look pretty.
5. Demo trade for 4–8 weeks.
...
- `docs/strategy.md` — exact trading logic and filters
- `docs/risk-rules.md` — capital-protection rules
- `docs/backtesting-checklist.md` — validation process
