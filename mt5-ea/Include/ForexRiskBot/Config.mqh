...
input bool   EnableResearchCsvLog = true;
input bool   LogBlockedSignalsToCsv = true;
...
input int    CompressionLookbackBars = 20;
input double CompressionMaxRangeRatio = 0.75;
input int    MinimumCompressionRangePoints = 60;
input bool   UseTrendFilterForBreakouts = true;
input bool   AllowLongPullbacks = false;
input bool   AllowShortPullbacks = false;
